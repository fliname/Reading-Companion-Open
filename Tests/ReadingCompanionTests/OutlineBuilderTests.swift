...
struct ReadingCompanionTests {
    ...
    @Test func inlineChapterSummaryRequiresLogicalPointsAndChapterRelations() {
        ...
        #expect(prompt.contains("500–900 字"))
    ...
    @Test func readingDepthKeepsRepliesBounded() {
        ...
        #expect(OpenAIService.responseBudgetInstructions(for: .economical).contains("700–1,000 个汉字"))
        #expect(budget.contains("1,200–1,800 个汉字"))
        #expect(OpenAIService.responseBudgetInstructions(for: .deep).contains("2,000–3,000 个汉字"))
