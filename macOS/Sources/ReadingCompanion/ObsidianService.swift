...
enum ObsidianNoteBuilder {
    ...
    static func highlightBlock(_ highlight: HighlightRecord) -> String {
        let displayedText = markdownSafeOriginalText(highlight.displayText)
    ...
    /// and HTML delimiters prevents Obsidian from interpreting part of a
    /// merged highlight as a tag, link or comment and hiding its middle.
    private static func markdownSafeOriginalText(_ source: String) -> String {
        source
