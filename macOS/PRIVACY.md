...
- PDF/EPUB/AZW3/MOBI 阅读、系统 OCR、电子书解码、目录识别、检索索引、书签、划线和批注主要在本机处理。无 DRM 的 AZW3/MOBI 由安装包内的 libmobi 离线转换，不上传书籍。
...
- 开启“联系全书”时，会额外发送目录与跨章节检索片段，但不会上传整份书籍文件。
...
用户应确保对打开的书籍及发送给第三方服务商的内容具有合法使用权。
